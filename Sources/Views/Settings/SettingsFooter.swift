...
struct SettingsFooter: View {
    ...
    private static let githubURL = URL(string: "https://github.com/Felix-wu998/codex-island")!
    private static let licenseURL = URL(string: "https://github.com/Felix-wu998/codex-island/blob/main/LICENSE")!
